...
- Name: .tmp-2b-ui.spec.ts >> 설정 휴지통과 자동추천 복구 탭
- Location: .tmp-2b-ui.spec.ts:186:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://127.0.0.1:3001/settings?view=trash
Call log:
  - navigating to "http://127.0.0.1:3001/settings?view=trash", waiting until "load"
